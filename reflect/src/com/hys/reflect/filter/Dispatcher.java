package com.hys.reflect.filter;
...
import com.hys.reflect.anno.RequestMapping;
import com.hys.reflect.controller.UserController;
...
//						System.out.println("password: " + password);
	...
	private <T> void setData(T instance, HttpServletRequest request) {
		...
		while(keys.hasMoreElements()) {
			...
			for(Method method: methods) {
				if (method.getName().contentEquals(methodKey)) {
					 try {
						if (instance.getClass().getDeclaredField(key).getType() == int.class) {
